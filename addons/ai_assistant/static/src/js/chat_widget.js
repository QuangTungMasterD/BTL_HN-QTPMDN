                ...
                <div id="ai_chat_wrapper">
                    ...
                    ">
                        ...
                        <div style="display:flex;position: absolute;bottom: 0;width: 100%; padding: 6px;">
                            <input placehoder="Nhập câu hỏi..." id="chat_input" style="flex:1;border:none;padding:8px 12px;outline:none; border-radius: 20px; border: 2px solid #007bff;">
